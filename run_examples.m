function [warp_img,center00]=run_examples(img1,img2,center,num)
close all
clc
...
[warp_img,center00]=SPHP_stitching(in_name, edge_list, ref, tar, warp_type, zeroR_ON,center,num); % run stitching
...
% img_n = 2;
% in_name = cell(img_n,1);
% in_name{2} = 'images/carpark_01.jpg';
% in_name{1} = 'images/carpark_02.jpg';
% edge_list = [1,2];

function [H, im1_, mask1, im2_, mask2] = surf128_mosaic(im1, im2, n1, n2)
...
[f1,d1] = vl_sift(im1g);
[f2,d2] = vl_sift(im2g); 
% fprintf('  Surf128 feature detection and matching...');tic;
% [f1,d1] = surf128(n1);
% [f2,d2] = surf128(n2); 
...
figure; plot(X1(1, :), X1(2, :), '.'); title('1');
figure; plot(X2(1, :), X2(2, :), '.'); title('2');
